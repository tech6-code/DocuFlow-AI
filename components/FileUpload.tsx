        ...
        <div className="lg:col-span-3 flex flex-col gap-6">
            <div className="bg-gray-900 p-6 rounded-lg border border-gray-700 shadow-sm">
                ...
                <div className="space-y-4">
                    ...
                    <p className="text-xs text-gray-500">Leave empty for non-protected PDFs.</p>
                </div>
            ...
            <div className="bg-gray-900 p-6 rounded-lg border border-gray-700 shadow-sm">
                <h3 className="text-base font-semibold mb-2 text-white">Selected file</h3>
                <div className="bg-gray-800 text-gray-300 rounded-md px-4 py-3 text-sm border border-gray-700 mb-4">
