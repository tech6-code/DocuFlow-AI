...
export const OpeningBalances: React.FC<OpeningBalancesProps> = ({ onComplete, currency, accountsData, onAccountsDataChange, onExport }) => {
            ...
            <div className="p-6 bg-gray-950 border-b border-gray-800">
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                    <div>
                        ...
                        <div className="flex items-center space-x-4 mt-4 bg-gray-900/50 p-3 rounded-lg border border-gray-800 w-fit">
