...
import { PlusIcon, UserCircleIcon, PhoneIcon, EnvelopeIcon, BuildingOfficeIcon, TagIcon, FunnelIcon, BriefcaseIcon, CalendarDaysIcon as CalendarIcon, ChatBubbleBottomCenterTextIcon, ArrowDownTrayIcon, SparklesIcon, ArrowPathIcon, ChartBarIcon, ExclamationTriangleIcon, LightBulbIcon } from './icons';
    ...
    return (
        <>
            ...
            <form onSubmit={handleSubmit} className="space-y-8 bg-gray-900 p-8 rounded-2xl border border-gray-800 shadow-xl relative">
                    ...
                    <div className="lg:col-span-2 space-y-8">
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                ...
                                <div className="space-y-2">
                                    <label className="text-sm font-medium text-gray-400 ml-1">Closing Date</label>
                                    <input
                                        type="date"
                                        name="closingDate"
                ...
                {/* Submit Button */}
                <div className="pt-4 flex justify-between items-center bg-gray-900 z-10 sticky bottom-0 border-t border-gray-800 pb-2">
                    <div className="flex gap-2">
                        <input
                            type="file"
                            accept=".xlsx, .xls"
