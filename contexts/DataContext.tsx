...
export const DataProvider = ({ children }: { children: ReactNode }) => {
    ...
    const projectCompanies = useMemo(() => {
        ...
        return customers.map(c => {
            ...
            return {
                id: c.id, name, address: c.billingAddress, trn: c.trn, corporateTaxTrn: c.corporateTaxTrn, incorporationDate: c.incorporationDate || '', businessType: c.entityType || '', financialYear: new Date().getFullYear().toString(), reportingPeriod: c.vatReportingPeriod || '', periodStart: start, periodEnd: end, dueDate: c.vatFilingDueDate,
