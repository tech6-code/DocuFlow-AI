...
export interface CtType1Context {
  ...
  onGenerateTrialBalance: any;
  onGenerateAuditReport: any;
  currency: string;
  companyName: string;
  ...
  handleBack: () => void;
  additionalFiles: any[];
  setAdditionalFiles: React.Dispatch<React.SetStateAction<any[]>>;
  vatProcessingStatus: string;
  isVatProcessing: boolean;
  handleVatUploadContinue: () => void;
  vatStepData: any;
  vatManualAdjustments: any;
  handleVatAdjustmentChange: any;
  handleExportVatSummary: any;
  handleVatSummarizationContinue: () => void;
  openingBalancesData: any;
  setOpeningBalancesData: any;
  handleOpeningBalancesComplete: () => void;
  openingBalanceFiles: any;
  setOpeningBalanceFiles: any;
  handleExtractOpeningBalances: any;
  isExtractingOpeningBalances: boolean;
  handleExportOpeningBalances: any;
  adjustedTrialBalance: any;
  setShowGlobalAddAccountModal: React.Dispatch<React.SetStateAction<boolean>>;
  openTbSection: any;
  setOpenTbSection: any;
  handleOpenWorkingNote: any;
  handleCellChange: any;
  handleExportStep4: any;
  handleContinueToProfitAndLoss: any;
  customRows: any;
  breakdowns: any;
  ...
  pnlWorkingNotes: any;
  handlePnlChange: any;
  handleExportStepPnl: any;
  handleAddPnlAccount: any;
  handleUpdatePnlWorkingNote: any;
  handleContinueToBalanceSheet: any;
  computedValues: any;
  bsStructure: any;
  bsWorkingNotes: any;
  handleBalanceSheetChange: any;
  handleExportStepBS: any;
  handleAddBsAccount: any;
  handleUpdateBsWorkingNote: any;
  handleContinueToLOU: any;
  louFiles: any;
  setLouFiles: any;
  handleContinueToQuestionnaire: any;
  questionnaireAnswers: any;
  setQuestionnaireAnswers: any;
  handleContinueToReport: any;
  ftaFormValues: any;
  reportForm: any;
  handleReportFormChange: any;
  handleExportStepReport: any;
  openReportSection: any;
  setOpenReportSection: any;
  ...
  handleCategorySelection: (val: string, context?: any) => void;
