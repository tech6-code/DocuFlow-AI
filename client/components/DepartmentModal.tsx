            ...
            <div className="bg-gray-900 rounded-lg shadow-xl w-full max-w-md m-4 border border-gray-700">
                <form onSubmit={handleSubmit}>
                    <div className="p-6 border-b border-gray-800 flex justify-between items-center">
                        <h3 className="text-lg font-semibold text-white">{isEditing ? 'Edit Department' : 'Add New Department'}</h3>
                    ...
                    <div className="p-6">
                        ...
                        <input 
                            ...
                            className="w-full p-2 border border-gray-600 rounded-md bg-gray-800 text-white focus:ring-white focus:border-white" 
                            required 
                            autoFocus
                        />
                    </div>
                    <div className="p-4 bg-gray-800/50 border-t border-gray-800 flex justify-end space-x-2">
                        ...
                        <button type="submit" className="px-4 py-2 bg-white text-black font-semibold rounded-lg hover:bg-gray-200 transition-colors text-sm shadow-sm">Save Department</button>
                    </div>
                </form>
            </div>
        </div>
