...
interface TradeLicenseUploadProps {
...
export const TradeLicenseUpload: React.FC<TradeLicenseUploadProps> = ({
    onFilesSelect,
    selectedFiles,
    previewUrls,
    onProcess
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 items-start">
            <div className="lg:col-span-3 flex flex-col gap-6">
                <div className="bg-card p-6 rounded-lg border border-border shadow-sm">
                    <h3 className="text-lg font-semibold mb-1 text-foreground">Trade License</h3>
                    <p className="text-muted-foreground mb-4 text-sm">Upload trade license documents.</p>
