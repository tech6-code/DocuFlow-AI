...
export const EmiratesIdUpload: React.FC<EmiratesIdUploadProps> = ({
    onFilesSelect,
    selectedFiles,
    previewUrls,
    onProcess
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 items-start">
            <div className="lg:col-span-3 flex flex-col gap-6">
                <div className="bg-card p-6 rounded-lg border border-border shadow-sm">
                    <h3 className="text-lg font-semibold mb-1 text-foreground">Emirates ID</h3>
                    <p className="text-muted-foreground mb-4 text-sm">Upload front and back of Emirates ID cards.</p>
                    ...
                    {previewUrls.length > 0 ? (
                        <>
                            <div className="absolute top-4 left-4 right-4 flex justify-between items-center z-10 px-2">
                                <h3 className="text-sm font-semibold text-foreground shadow-black drop-shadow-md">Preview</h3>
                                {previewUrls.length > 1 && (
                                    <span className="text-xs text-foreground bg-background/50 px-2 py-1 rounded-full backdrop-blur-sm font-mono">
