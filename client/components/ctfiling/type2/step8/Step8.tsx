...
import {
    AssetIcon, ScaleIcon, IncomeIcon, ExpenseIcon, EquityIcon, BriefcaseIcon,
    DocumentArrowDownIcon, PlusIcon, ChevronDownIcon, ChevronRightIcon
} from '../../../icons';
import { formatWholeNumber } from '../types';
import { CHART_OF_ACCOUNTS } from '../../../../services/geminiService';
import { LoadingIndicator } from '../../../LoadingIndicator';

const roundAmount = (num: number) => Math.round(num);
...
export const Step8: React.FC = () => {
    ...
    const { sections, variance, roundedGrandTotal } = useMemo(() => {
        ...
        return { sections, variance, roundedGrandTotal };
    }, [openingBalancesData]);
