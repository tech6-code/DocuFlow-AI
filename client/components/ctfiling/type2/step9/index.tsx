...
export const Step9: React.FC = () => {
    ...
    if (adjustedTrialBalance) {
        adjustedTrialBalance.forEach((entry: any) => {
    ...
    const adjustedTrialBalanceExclTotals = (adjustedTrialBalance || []).filter((item: any) => item.account.toLowerCase() !== 'totals');

    adjustedTrialBalanceExclTotals.forEach((entry: any) => {
