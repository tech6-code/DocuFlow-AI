...
export interface ICtType4Context {
    currentStep: number;
    ...
    // Step 1: Audit Report
    auditFiles: File[];
    setAuditFiles: React.Dispatch<React.SetStateAction<File[]>>;
    extractedDetails: Record<string, any>;
    setExtractedDetails: React.Dispatch<React.SetStateAction<Record<string, any>>>;
    isExtracting: boolean;
    setIsExtracting: React.Dispatch<React.SetStateAction<boolean>>;
    openExtractedSection: string | null;
    setOpenExtractedSection: React.Dispatch<React.SetStateAction<string | null>>;
    ...
    isExtractingVat: boolean;
    setIsExtractingVat: React.Dispatch<React.SetStateAction<boolean>>;
    showVatConfirm: boolean;
    setShowVatConfirm: React.Dispatch<React.SetStateAction<boolean>>;
    vatStepData: any; // Derived
...
export const CtType4Context = React.createContext<ICtType4Context>({} as ICtType4Context);

export const useCtType4 = () => React.useContext(CtType4Context);
