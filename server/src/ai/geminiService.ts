...
const LOCAL_RULES = [
    ...
    { keywords: ["ETISALAT", "Mobily", "EmiratestechnologyIntegrated", "Telephone", "Internet"], category: "Expenses|OtherExpenses|Utilities (Electricity, Water, Internet)" },
    { keywords: ["ENOC", "ADNOC", "EMARAT", "Fuel", "Petrol"], category: "Expenses|OtherExpenses|Transportation & Logistics" },
    { keywords: ["RTA", "Salik", "Emirates", "Careem", "Taxi", "Uber"], category: "Expenses|OtherExpenses|Travel & Entertainment" },
    { keywords: ["Google", "Facebook", "Face book", "Godaddy", "DU", "Mobile Expenses", "MYFATOORAH DUBAI", "Software", "Subscription", "Cloud"], category: "Expenses|OtherExpenses|IT & Software Subscriptions" },
    { keywords: ["Visaexpenses", "Visa expenses", "Immigration", "Labor"], category: "Expenses|OtherExpenses|Government Fees & Licenses" },
