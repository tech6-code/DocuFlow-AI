...
export const CHART_OF_ACCOUNTS = {
    Assets: {
        ...
        IntangibleAssets: ["Patents", "Trademarks", "Copyrights", "Goodwill", "Licenses"],
    ...
    Liabilities: {
        CurrentLiabilities: [
            ...
            "Accrued Expenses",
            "Accrued Expenses (Salaries Payable, Interest Payable)",
    ...
    Income: {
        ...
        OtherIncome: [
            ...
            "Discount Received",
            "Bad Debts Recovered",
            "Unrealised Gain on FVTP(L) Investments",
    ...
    Expenses: {
        DirectCosts: [
            ...
            "Direct Labor",
            "Factory Overhead",
            "Freight Inwards/Carriage Inwards",
        ...
        OtherExpense: [
            ...
            "Impairment Loss on Equipment/Machinery/Land and Building",
            "Impairment Loss on Goodwill/Patents/Trademarks",
            "Loss on Revaluation of Investment Property",
            "Unrealised Loss on FVTP(L) Investments",
            "Bad Debt Expense",
